...
Many useful functions do not come preloaded when you start R, but reside in packages to be installed on top of R. For the tutorial, please install some packages in advance ("tidyverse", "caret", "e1071", "mlr"). To do that, type 
```{r, eval=FALSE}
